...
export function DeadlineBadge({
  ...
  const isCustomEarlier =
    customDeadline &&
    (customDeadline instanceof Date ? customDeadline : new Date(customDeadline)).getTime() <
    (computedDeadline instanceof Date ? computedDeadline : new Date(computedDeadline)).getTime();
  ...
  if (days < 0) {
    ...
    // Due soon (1-3 days) - orange warning
    customClasses = 'bg-orange-100 text-orange-800 border-orange-200';
  }
