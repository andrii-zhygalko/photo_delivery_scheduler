...
/**
 * SkeletonCard - Loading skeleton matching ItemCard layout
 *
 * Features:
 * - Simple border (no gradient) for cleaner loading state
...
export function SkeletonCard({
  ...
  return (
    <Card
      className={cn(
        'bg-gradient-card/70 h-full flex flex-col shadow-none',
        className
      )}
      aria-busy='true'
